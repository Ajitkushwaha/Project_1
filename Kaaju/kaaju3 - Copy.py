...
def TaskExe():
    ...
    def screenshot():
        ...
        path = takecommand()
        path1name = path + ".png"
        path1 = "E:\\Kaushik rest\\Screenshots\\"+ path1name
    ...
    while True:
        ...
        if 'hello' in query:
            ...
            Speak("Just Say Wake Up Kaaju!")
            break

        elif 'youtube search' in query:
            Speak("OK sIR , This Is What I found For Your Search!")
            query = query.replace("Kaaju","")
            ...
            remeberMsg = remeberMsg.replace("Kaaju","")
            ...
            op = query.replace("Kaaju","")
            max_result = 1
            how_to_func = search_pywikihow(op,max_result)
